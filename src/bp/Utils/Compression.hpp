...
// bp
#include <bp/Collection/Vector/C++/Vector.hpp>
#include <bp/Collection/Vector/C++/Mutable.hpp>

inline Size bp_compressMaxSize(int inputSize) {
	return LZ4_compressBound(inputSize);
}

inline void bp_compress(Byte* source, BPMutableVector<Byte>* dest, Size size) {
...
inline void bp_uncompress(BPMutableVector<Byte>* compressed, BPMutableVector<Byte>* out) {
